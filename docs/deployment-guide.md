...
| [Multi-Region Failover](runbooks/multi-region-failover.md) | Detect a region failure, execute failover steps, verify recovery, and roll back if needed. RTO ≤ 30 min, RPO = 0. |
